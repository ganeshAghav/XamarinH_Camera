package md5a1a55961ad5ff085faecb6fa0d66e212;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("BlackFramework.Droid.HybridWebView+HybridWebChromeClient, BlackFramework.Android, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", HybridWebView_HybridWebChromeClient.class, __md_methods);
	}


	public HybridWebView_HybridWebChromeClient ()
	{
		super ();
		if (getClass () == HybridWebView_HybridWebChromeClient.class)
			mono.android.TypeManager.Activate ("BlackFramework.Droid.HybridWebView+HybridWebChromeClient, BlackFramework.Android, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}

	public HybridWebView_HybridWebChromeClient (android.content.Context p0)
	{
		super ();
		if (getClass () == HybridWebView_HybridWebChromeClient.class)
			mono.android.TypeManager.Activate ("BlackFramework.Droid.HybridWebView+HybridWebChromeClient, BlackFramework.Android, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new java.lang.Object[] { p0 });
	}
